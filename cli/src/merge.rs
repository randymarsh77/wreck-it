...
/// through the merge pipeline (mark ready → merge).  Merge-ralph PRs use
/// merge commits (not squash) because they represent true merges of the base
...
pub async fn run_merge(
    ...
    // Also promote any legacy pending_merge_issues (backward compat with
    // state files written by an older version of wreck-it).
