                ...
                if has_checks {
                    ...
                    if has_failures {
                        ...
                        if brute {
                            ...
                            match client
                                .merge_pr(pr_number, tracked.merge_method.as_deref())
                                .await
                            {
                                Ok(()) => {
                            ...
                            if let Err(e) = client
                                .enable_auto_merge(pr_number, tracked.merge_method.as_deref())
                                .await
                            {
                                println!(
            ...
            if has_checks {
                ...
                if has_failures {
                    ...
                    if brute {
                        ...
                        if let Err(e) = client
                            .enable_auto_merge(pr_number, pr_merge_method.as_deref())
                            .await
                        {
                            println!(
